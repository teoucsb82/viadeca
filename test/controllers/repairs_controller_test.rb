...
class RepairsControllerTest < ActionController::TestCase
  ...
  test "should create repair" do
    assert_difference('Repair.count') do
      post :create, repair: { description: @repair.description, location_address: @repair.location_address, phn: @repair.phn, repair_details: @repair.repair_details, status: @repair.status }
    end
  ...
  test "should update repair" do
    patch :update, id: @repair, repair: { description: @repair.description, location_address: @repair.location_address, phn: @repair.phn, repair_details: @repair.repair_details, status: @repair.status }
    assert_redirected_to repair_path(assigns(:repair))
  end
